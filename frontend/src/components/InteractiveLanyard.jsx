...
export default function InteractiveLanyard({ name = "Miryam Abida", title = "Creative Developer", position = [0, 0, 30], gravity = [0, -40, 0], fov = 20, transparent = true }) {
        ...
        <div className="relative z-0 w-full h-[500px] flex justify-center items-center transform scale-100 origin-center">
            ...
            >
                ...
                <Physics gravity={gravity} timeStep={isMobile ? 1 / 30 : 1 / 60}>
                    <Band isMobile={isMobile} name={name} title={title} />
                </Physics>
...
function Band({ name, title, maxSpeed = 50, minSpeed = 0, isMobile = false }) {
